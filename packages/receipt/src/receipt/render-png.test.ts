...
import { renderReceiptPng as renderWithAssets } from './render-png';
import {fileURLToPath} from 'node:url';
const renderReceiptPng = (model:ReceiptModel) => renderWithAssets(model,{assetRoot:fileURLToPath(new URL('../../assets/',import.meta.url))});
import { redactReceipt } from './redact';
