...
import { aggregateByModel, filterDays, sumGrain, totalTokens } from '@chaching/shared/aggregate';
import { cacheCostBreakdown } from '@chaching/shared/pricing/cache-breakdown';
import { aggregateProjects, inWindow } from '@chaching/shared/view-model';
import {
	buildSubsidisation,
	type ProviderSubsidisationConfig,
	type SubsidisedProvider
} from '@chaching/shared/subsidisation';
import { modelFamily, modelLabel } from '@chaching/shared/format';
...
export function buildWrapped(snapshot: RollupSnapshot, opts: BuildWrappedOptions = {}): WrappedModel {
	...
	// Cache savings retain the original valuation components.
