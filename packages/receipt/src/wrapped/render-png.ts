...
import { money, compactTokens, int } from '@chaching/shared/format';
import { renderPng, svgToPngDataUri, type RenderNode } from '../receipt/png-pipeline';
import { barWidths, GOLD_MARK_SVG, PAPER } from '../receipt/assets';
import type { WrappedModel } from './model';
...
export async function renderWrappedPng(model: WrappedModel, {assetRoot}: {assetRoot: string}): Promise<Buffer> {
