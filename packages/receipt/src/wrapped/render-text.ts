...
import {accent, bold, dim} from '@chaching/shared/voice/personality';
import {noColor as resolveNoColor, noArt as resolveNoArt} from '@chaching/shared/voice/suppress';
import { RECEIPT_WIDTH } from '../receipt/render-text';
...
function resolveEnv(e: RenderTextEnv): { noArt: boolean; noColor: boolean; env: Record<string, string | undefined> } {
	const env = e.env ?? {};
	return {
