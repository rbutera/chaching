...
import { loadConfig, updateConfig, type chachingConfig } from '@chaching/core/config';
import { parseIntervalMinutes, performSyncAction } from '@chaching/core/sync/manager';
import { hostname } from 'node:os';
import { noArt, accent } from './theme/personality';
