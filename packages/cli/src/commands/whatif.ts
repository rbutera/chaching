...
import { buildScenarios } from '@chaching/core/whatif/engine';
import { PRICE_ONLY_COUNTERFACTUAL } from '@chaching/shared/whatif/types';
import type { ScenarioResult, ScenarioExclusion } from '@chaching/shared/whatif/types';
import { defaultAltTarget, windowModelsPresent } from '@chaching/shared/whatif/targets';
import { filterDays, sumGrain } from '@chaching/shared/aggregate';
import type { Totals } from '@chaching/shared/aggregate';
import { defaultViewState, periodWindow } from '@chaching/shared/view-model';
import { money, int } from '@chaching/shared/format';
import type { Period, RollupSnapshot } from '@chaching/shared/types';
import { noArt as resolveNoArt, wordmark, emptyLine, dim } from '../theme/personality';
