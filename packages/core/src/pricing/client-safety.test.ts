...
function read(relFromHere: string): string {
	return readFileSync(join(here, ({ '../../client/dashboard.svelte.ts': '../../../../apps/web/src/lib/client/dashboard.svelte.ts', '../../pricing-client.ts': '../../../shared/src/pricing-client.ts' } as Record<string, string>)[relFromHere] ?? '../../../shared/src/pricing/' + relFromHere), 'utf8');
}
