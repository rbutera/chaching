...
<style>
	...
	nav{display:flex;gap:24px}button,select{font:inherit;color:inherit}button{cursor:pointer;background:none;border:0;min-height:44px;padding:8px 0;text-align:left}button:hover{color:var(--accent-ink)}button:focus-visible,select:focus-visible{outline:2px solid var(--accent);outline-offset:4px}
	...
	.current-focus{display:grid;grid-template-columns:1.2fr 1fr;border:1px solid var(--border)}.current-focus article{padding:24px 28px}.current-focus article+article{border-left:1px solid var(--border)}.current-focus article.attention{background:var(--accent-soft);border-top:3px solid var(--accent);padding-top:21px}.account-top{display:flex;align-items:start;justify-content:space-between;gap:16px}.account-name{display:flex;flex-direction:column;gap:3px}.account-name strong{font-size:var(--text-lg)}.account-name span,.available{font-size:var(--text-xs);color:var(--text-muted)}.active{font:var(--type-label);color:var(--accent-ink);padding-top:5px}.quota-pair{display:grid;grid-template-columns:1fr 1fr;gap:28px;margin-top:30px}.window-label{display:flex;justify-content:space-between;align-items:baseline;gap:10px;font-size:var(--text-sm)}.remaining{font-size:var(--text-xs);color:var(--text-muted)}.remaining b{font:700 30px/1.2 var(--font-sans);color:var(--text)}.low .remaining b{color:var(--accent-ink)}meter{display:block;width:100%;height:7px;appearance:none;border:0;margin:12px 0;background:var(--border);border-radius:0}meter::-webkit-meter-bar{background:var(--surface-3);border:0;border-radius:0;height:7px}meter::-webkit-meter-optimum-value{background:var(--paper-200)}.low meter::-webkit-meter-optimum-value{background:var(--accent)}meter::-moz-meter-bar{background:var(--paper-200)}small{font-size:var(--text-xs);color:var(--text-muted)}
	...
	.spend,.ledger .spend,.lanes .spend{margin:0 0 30px;padding:20px 0 24px;background:transparent;border-top:0}.spend :global(.money){font-size:clamp(32px,3.9vw,56px);line-height:1.15;letter-spacing:-.055em}.spend .flavour{display:block;min-height:20px;margin-top:12px;font-size:var(--text-xs);color:var(--accent-ink)}
	...
	:global(input::placeholder){color:var(--text-muted);opacity:1}:global(::selection){color:var(--text-on-gold);background:var(--accent-ink)}:global(html){scrollbar-color:var(--text-dim) var(--surface-1);caret-color:var(--accent-ink)}
