...
// 2026-06: Opus = $5/$25 per Mtok in/out, cache-write 5m = $6.25, cache-write
// 1h = $10, cache-read = $0.50. Sonnet = $3/$15, cache-write $3.75/$6, read
// $0.30. Haiku 4.5 = $1/$5, cache-write $1.25/$2, read $0.10.
