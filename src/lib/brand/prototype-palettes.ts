...
export const palettes: Palette[] = [
	...
	{ id: 'register-light', name: 'Register & Receipt Light', scheme: 'light', note: 'Neutral white surfaces, dark ink and brass. No cream tint on the dashboard.', surfaces: ['#ffffff','#fafafa','#f4f4f4','#ededed'], border: '#c4c4c4', text: '#202020', muted: '#545454', dim: '#626262', accent: '#855a08', purple: '#7142ae', blue: '#12668e', yellow: '#536700', green: '#246b40', red: '#ab3434', orange: '#995015' },
	...
	{ id: 'mocha', name: 'Catppuccin Mocha', scheme: 'dark', note: 'Mauve action accent; peach carries money and warm spend, yellow stays a model category. Familiar pastel hues on dark violet surfaces.', surfaces: ['#181825','#1e1e2e','#242436','#313244'], border: '#585b70', text: '#cdd6f4', muted: '#bac2de', dim: '#a6adc8', accent: '#cba6f7', purple: '#cba6f7', blue: '#89b4fa', yellow: '#f9e2af', green: '#a6e3a1', red: '#f38ba8', orange: '#fab387' },
...
export function paletteVars(p: Palette) {
	return {
		...
		'accent': p.accent, 'accent-bright': p.accent, 'accent-press': p.accent, 'focus-ring': p.accent,
		'accent-soft': p.surfaces[2], 'accent-line': p.accent, 'text-on-gold': p.surfaces[0],
		'good': p.green, 'bad': p.red, 'warn': p.yellow, 'info': p.blue,
		'm-opus': p.purple, 'm-sonnet': p.blue, 'm-haiku': p.yellow, 'm-other': p.muted,
		'p-claude': p.purple, 'p-codex': p.blue, 'p-opencode': p.green, 'p-cursor': p.yellow, 'p-pi': p.red, 'p-unknown': p.muted,
		...
		'gold-400': p.accent, 'gold-500': p.accent, 'gold-600': p.accent, 'paper-200': p.muted,
		'purple': p.purple, 'sky': p.blue, 'lemon': p.yellow, 'mint': p.green, 'slate': p.muted
	};
}

export const semanticGroups = {
	'Text': ['text','text-muted','text-dim','accent','focus-ring'],
	'Providers': ['p-claude','p-codex','p-opencode','p-cursor','p-pi','p-unknown'],
	'Model slots': ['m-opus','m-sonnet','m-haiku','m-other'],
