<script lang="ts">
	...
	import type { DayCell } from '@chaching/shared/view-model';
	import type { DayCoverage } from '@chaching/shared/types';
	import { money, fmtDay } from '@chaching/shared/format';
	...
	import {
		...
		placeCells,
		type PlacedCell
	} from '@chaching/shared/heatmap-layout';
