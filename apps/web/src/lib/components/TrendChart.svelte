<script lang="ts">
	...
	import { modelColor, modelLabel, money, fmtPeriodKey } from '@chaching/shared/format';
	import type { PeriodBucket } from '@chaching/shared/aggregate';
	import { barFill, tooltipSuffix, ariaProvenance } from '@chaching/shared/coverage-marks';
