<script lang="ts">
	...
	import { poolGrain, defaultViewState, type ViewState } from '@chaching/shared/view-model';
	import type { DrillTarget } from '../client/dashboard.svelte';
	import type { RollupSnapshot, TokenCounts } from '@chaching/shared/types';
