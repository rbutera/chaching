<script lang="ts">
	...
	import StatCard from '../ds/StatCard.svelte';
	import { money, compactTokens, modelLabel, modelColor, int } from '@chaching/shared/format';
	import { totalTokens } from '@chaching/shared/aggregate';
	import { coverageSub } from '@chaching/shared/coverage-marks';
