<script lang="ts">
	...
	import { pctDelta } from '@chaching/shared/format';
	import { coverageWord } from '@chaching/shared/coverage-marks';
	import { flourishFor, formatFlourishText, DAILY_FLOURISHES, LIFETIME_FLOURISHES, BLOCK_FLOURISHES } from '@chaching/shared/voice/index';
