...
- Unresolved legacy matches need a final pooled fee-total audit. Existing local fee derivation suppresses unknown/conflicting fees; this must hold across every pooled report path.
